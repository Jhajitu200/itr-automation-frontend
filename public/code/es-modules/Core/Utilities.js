...
function getStyle(el, prop, toInt) {
    ...
    if (prop === 'width') {
        ...
        // In flex boxes, we need to use getBoundingUserRect and floor it,
        // because scrollWidth doesn't support subpixel precision (#6427) ...
        var boundingUserRectWidth = el.getBoundingUserRect &&
            el.getBoundingUserRect().width;
        // ...unless if the containing div or its parents are transform-scaled
        // down, in which case the boundingUserRect can't be used as it is
        // also scaled down (#9871, #10498).
        if (boundingUserRectWidth < offsetWidth &&
            boundingUserRectWidth >= offsetWidth - 1) {
            offsetWidth = Math.floor(boundingUserRectWidth);
        }
