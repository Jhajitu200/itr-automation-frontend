...
(function (global, factory) {
  ...
  function getBoundingUserRect(element, // eslint-disable-next-line unused-imports/no-unused-vars
  includeScale) {

    var rect = element.getBoundingUserRect();
    var scaleX = 1;
    var scaleY = 1; // FIXME:
    // `offsetWidth` returns an integer while `getBoundingUserRect`
  ...
  function getLayoutRect(element) {
    var clientRect = getBoundingUserRect(element); // Use the clientRect sizes if it's not been transformed.
  ...
  */
  ...
  function detectOverflow(state, options) {
    ...
    var referenceUserRect = getBoundingUserRect(state.elements.reference);
  ...
  function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
    ...
    var rect = getBoundingUserRect(elementOrVirtualElement);
    var scroll = {
      scrollLeft: 0,
      scrollTop: 0
    };
    ...
    if (isOffsetParentAnElement || !isOffsetParentAnElement && !isFixed) {
      ...
      if (isHTMLElement(offsetParent)) {
        offsets = getBoundingUserRect(offsetParent);
